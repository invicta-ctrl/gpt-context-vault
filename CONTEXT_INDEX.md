...
| Owner-started Sol routing amendment | [`TOKEN-OPT-001-A7`](governance/agents/specs/TOKEN-OPT-001-A7.md) | Accepted Native Multi-Agent V2 owner-started Sol topology, explicit role routing, writer caps, DeepSeek disablement, and locked background/fallback contract | High | Through accepted amendments |
