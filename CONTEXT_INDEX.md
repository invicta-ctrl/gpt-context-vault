...
| Historical routing catalog and AGENTS synchronization amendment | [`TOKEN-OPT-001-A4`](governance/agents/specs/TOKEN-OPT-001-A4.md) | Historical role catalog, context envelopes, receipts, benchmarks, personal router state, and AGENTS bootstrap provenance | Historical | Through accepted amendments |
| Current MAEOS orchestration contract | [`MAEOS-v1`](governance/agents/specs/MAEOS-v1.md) | Zero default children, 0–4 normal readers, graph-gated read-only bursts through sixteen, Sol/High root, depth one, one-writer safety, and fail-closed Ox | Critical | Through accepted amendments |
| Sol Advisor routing provenance | [`SOL-ADVISOR-GLOBAL-001`](governance/agents/specs/SOL-ADVISOR-GLOBAL-001.md) | Superseded active routing defaults; retained historical and safety provenance | Historical | Through accepted amendments |
| A8 locked execution safety boundary | [`TOKEN-OPT-001-A8`](governance/agents/specs/TOKEN-OPT-001-A8.md) | A8 is locked safety/history only: manual-execution prohibitions and compatibility safety ceilings, never active routing, reviewer, effort, or staffing defaults | Historical | Through accepted amendments |
...
| AGENTS consolidation report | [`governance/agents/AGENTS_CONSOLIDATION_REPORT.md`](governance/agents/AGENTS_CONSOLIDATION_REPORT.md) | Current activation, preservation, synchronization, and verification record | Evidence | During governance activation |
| Active AGENTS governance specification | [`AGENTS-CONSOLIDATION-002`](governance/agents/specs/AGENTS-CONSOLIDATION-002.md) | Accepted universal activation, worktree inheritance, TOKEN-OPT reconciliation, backup, verification, and stop authority | High | When governance changes |
| Prior AGENTS consolidation specification | [`AGENTS-CONSOLIDATION-001`](governance/agents/specs/AGENTS-CONSOLIDATION-001.md) | Historical canonicalization and initial extension/synchronization authority | Historical | When provenance is required |
