...
| Current Sol Advisor routing contract | [`SOL-ADVISOR-GLOBAL-001`](governance/agents/specs/SOL-ADVISOR-GLOBAL-001.md) | `solo|delegate|audit|full`; solo is the default with at most one auxiliary; Luna / Max and Terra / High are native implementation lanes; Ox is implementation-only and fail-closed | Critical | Through accepted amendments |
