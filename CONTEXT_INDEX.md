...
| Projects | [`projects/PROJECT_REGISTRY.md`](projects/PROJECT_REGISTRY.md) | Active project directory | High for project routing | As projects change |
...
| Recent changes | [`memory/RECENT_CHANGES.md`](memory/RECENT_CHANGES.md) | Latest context updates | Medium | After meaningful updates |
