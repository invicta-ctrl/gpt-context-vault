...
| Incremental project setup | [`templates/INCREMENTAL_CODEX_PROJECT_SETUP_TEMPLATE.md`](templates/INCREMENTAL_CODEX_PROJECT_SETUP_TEMPLATE.md) | Copy-ready project capsule, codebase map, implementation plan, pointer, step packet, checkpoint, and continuation skill templates | Operational | As continuation workflow improves |
